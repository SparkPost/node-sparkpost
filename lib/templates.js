...
module.exports = function(client) {
  var templates = {
    ...
    update: function(template, callback) {
      ...
      reqOpts = {
        uri: api + '/' + template.id
        , json: _.cloneDeep(template)
        , qs: {}
      };

      delete reqOpts.json.id;

      if(reqOpts.json.update_published) {
        reqOpts.qs.update_published = reqOpts.json.update_published;
        delete reqOpts.json.update_published;
      }
