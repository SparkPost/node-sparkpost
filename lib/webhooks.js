...
module.exports = function(client) {
  return {
     ...
     * Lists all webhooks
     *
     * @param {Object} options - Hash of the webhook attributes to update
    ...
    /**
     * Validate that a webhook can receive a batch.
     *
    ...
    /**
     * Gets the most recent status information about a webhook.
     *
    ...
    /**
     * Gets documentation about the events and fields pushed from SparkPost to a webhook.
     *
     * @param {RequestCb} [callback]
     * @returns {Promise}
     */
