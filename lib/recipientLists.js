...
module.exports = function(client) {
  var recipientLists = {
    ...
    create: function(recipientList, callback) {
      ...
      if (recipientList.num_rcpt_errors) {
        reqOpts.qs.num_rcpt_errors = recipientList.num_rcpt_errors;
        delete recipientList.num_rcpt_errors;
      }

      reqOpts.json = recipientList;
