...
var api = 'subaccounts'
  ...
  , toApiFormat = function(input) {
    ...
    if (input.keyValidIps) {
      keyValidIpsIsArray = Array.isArray(input.keyValidIps);
  ...
  , validateCreateOptions = function(input) {
    if (!input.name) {
...
module.exports = function(client) {
  var subaccounts = {
    ...
    create: function(options, callback) {
      ...
      validation = validateCreateOptions(options);
      if (validation) {
