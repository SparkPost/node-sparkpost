...
/**
 *  Method for adding a single recipient to a Transmission
 *
 ...
 *
 *  @param recipient object Recipient data to send a Transmission
 */
Transmission.prototype.addRecipient = function(recipient) {
  var self = this;

  // Handle the case that someone already tried setting a recipient list; override recipient list
...
/**
 *  Method for adding multiple recipients at once to a Transmission
 *
 *  Used for supplying inline recipients for a Transmission. Emails will be generated
 *  for each recipient in the list.
 *
 ...
 *
 *  @param recipients array Array of objects containing recipient data
 */
Transmission.prototype.addRecipients = function(recipients) {
  var self = this;
  ...
  this.model.recipients = this.model.recipients.concat(recipients);
  return this;
};
