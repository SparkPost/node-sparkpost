...
var Transmission = function(params) {
  ...
  this.model.open_tracking = params.openTracking || true;
  this.model.click_tracking = params.clickTracking || true;
  this.model.use_draft_template = params.useDraftTemplate || false;
};
