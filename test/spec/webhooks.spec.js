...
describe('Webhooks Library', function () {
  ...
  describe('list Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return webhooks.list(callback).then(function () {
    ...
    it('should allow timezone to be set in options', function () {
      ...
      return webhooks.list(options).then(function () {
  ...
  describe('get Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return webhooks.get('test', callback).then(function () {
    ...
    it('should allow timezone to be set in options', function () {
      ...
      return webhooks.get('test', options).then(function () {
        expect(client.get.firstCall.args[0].qs).to.deep.equal({ timezone: 'America/New_York' })
      })
    })
  })
  ...
  describe('create Method', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return webhooks.create(webhook, callback).then(function () {
  ...
  describe('update Method', function () {
    it('should call client put method with the appropriate uri', function () {
      ...
      return webhooks.update('test', webhook, callback).then(function () {
  ...
  describe('delete Method', function () {
    it('should call client delete method with the appropriate uri', function () {
      return webhooks.delete('test', callback).then(function () {
  ...
  describe('validate Method', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return webhooks.validate('test', options, callback).then(function () {
  ...
  describe('getBatchStatus Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return webhooks.getBatchStatus('test', callback).then(function () {
    ...
    it('should allow limit to be set in options', function () {
      ...
      return webhooks.getBatchStatus('test', options).then(function () {
  ...
  describe('getDocumentation Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return webhooks.getDocumentation(callback).then(function () {
  ...
  describe('getSamples Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return webhooks.getSamples(callback).then(function () {
    ...
    it('should allow events to be set in options', function () {
      ...
      return webhooks.getSamples(options).then(function () {
