...
describe('Relay Webhooks Library', function () {
  ...
  describe('list Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return relayWebhooks.list(callback).then(function () {
  ...
  describe('get Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return relayWebhooks.get('test', callback).then(function () {
  ...
  describe('create Method', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return relayWebhooks.create(webhook, callback).then(function () {
  ...
  describe('update Method', function () {
    it('should call client put method with the appropriate uri and payload', function () {
      ...
      return relayWebhooks.update('test', webhook, callback).then(function () {
  ...
  describe('delete Method', function () {
    it('should call client delete method with the appropriate uri', function () {
      return relayWebhooks.delete('test', callback).then(function () {
