...
describe('Suppression List Library', function () {
  ...
  describe('list', function () {
    it('should call client get method with the appropriate uri', function () {
      return suppressionList.list({ limit: 5 }, callback).then(function () {
  ...
  describe('get', function () {
    it('should call client get method with the appropriate uri', function () {
      return suppressionList.get('test@test.com', callback).then(function () {
  ...
  describe('upsert', function () {
    it('should accept a single list entry', function () {
      ...
      return suppressionList.upsert(listEntry, callback).then(function () {
    ...
    it('should accept an array of list entries', function () {
      var listEntries = [{ email: 'test1@test.com' }, { email: 'test2@test.com' }]

      return suppressionList.upsert(listEntries).then(function () {
        expect(client.put.firstCall.args[0].uri).to.equal('suppression-list')
  ...
  describe('delete', function () {
    it('should call client delete method with the appropriate uri', function () {
      return suppressionList.delete('test@test.com', callback).then(function () {
