...
describe('Templates Library', function () {
  ...
  describe('list Method', function () {
    it('should call client get method with the appropriate uri', function () {
      return templates.list(callback).then(function () {
  ...
  describe('get Method', function () {
    it('should call client get method with the appropriate uri', function () {
      var id = 'test'
      return templates.get(id, callback).then(function () {
    ...
    it('should allow draft to be set in options', function () {
      ...
      return templates.get(id, options).then(function () {
  ...
  describe('create Method', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return templates.create(template, callback).then(function () {
  ...
  describe('update Method', function () {
    it('should call client put method with the appropriate uri and payload', function () {
      ...
      return templates.update(id, template, callback).then(function () {
    ...
    it('should allow update_published to be set in options', function () {
      ...
      return templates.update(id, template, options).then(function () {
  ...
  describe('delete Method', function () {
    it('should call client delete method with the appropriate uri', function () {
      return templates.delete('test', callback).then(function () {
  ...
  describe('preview Method', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return templates.preview(id, options, callback).then(function () {
    ...
    it('should add the draft option to query params', function () {
      ...
      return templates.preview(id, options).then(function () {
