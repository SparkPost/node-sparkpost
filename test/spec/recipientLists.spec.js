...
describe('Recipient Lists Library', function () {
  ...
  describe('list', function () {
    it('should call client get method with the appropriate uri', function () {
      return recipientLists.list(callback).then(function () {
  ...
  describe('get', function () {
    it('should call client get method with the appropriate uri', function () {
      return recipientLists.get('test-id', callback).then(function () {
    ...
    it('should allow show_recipients to be set in options', function () {
      ...
      return recipientLists.get('test-id', options).then(function () {
  ...
  describe('create', function () {
    it('should call client post method with the appropriate uri and payload', function () {
      ...
      return recipientLists.create(testList, callback).then(function () {
    ...
    it('should throw an error if no recipients are provided', function () {
      return Promise.all([
        ...
        expect(
          recipientLists.create(function () {}),
          'recipient list is actually a callback'
        ).to.be.rejectedWith('recipient list is required')
      ])
    })
    ...
    it('should allow num_rcpt_errors to be set in options', function () {
      ...
      return recipientLists.create(testList).then(function () {
  ...
  describe('update', function () {
    it('should call client put method with the appropriate uri and payload', function () {
      ...
      return recipientLists.update(testId, testList, callback).then(function () {
    ...
    it('should allow num_rcpt_errors to be set in options', function () {
      ...
      return recipientLists.update('test-id', testList).then(function () {
  ...
  describe('delete', function () {
    it('should call client delete method with the appropriate uri', function () {
      return recipientLists.delete('test', callback).then(function () {
